...
export function DecisionTreeAssessment() {
  ...
  if (session?.riskClassification) {
    ...
    let mappedRisk: "unacceptable" | "high" | "limited" | "minimal" | "out_of_scope" = "minimal";
    ...
    if (mappedRisk === "unacceptable") {
      ...
      badgeColor = "border-gap/40 bg-gap-soft/20 text-gap";
      riskTierLabel = "Limited Risk AI System (Article 50)";
    } else if (mappedRisk === "minimal") {
      badgeColor = "border-fact/30 bg-fact-soft/30 text-fact";
      riskTierLabel = "Minimal Risk AI System (Article 95/etc.)";
    } else {
      badgeColor = "border-foreground/30 bg-muted text-foreground";
        ...
        <div className="grid gap-6 md:grid-cols-[55fr_45fr]">
          ...
          <div className="flex flex-col justify-between border-b border-hairline pb-6 md:border-b-0 md:border-r md:border-hairline md:pb-0 md:pr-6">
            ...
            <div className="mt-6 flex flex-wrap gap-2 pt-4">
              ...
              {mappedRisk === "minimal" && <Tag variant="fact">Minimal Risk System</Tag>}
          ...
          <div className="flex flex-col items-center justify-center p-6 text-center">
            <div className="space-y-4 max-w-sm">
              ...
              <button
                onClick={() => {
                  const el = document.getElementById("verda-copilot");
                  if (el) {
    ...
    <section className="rounded-lg border border-hairline bg-card p-7 md:p-9">
      ...
      <div className="grid gap-6 md:grid-cols-[55fr_45fr]">
        <div className="flex flex-col justify-between border-b border-hairline pb-6 md:border-b-0 md:border-r md:border-hairline md:pb-0 md:pr-6">
          <div>
            <div className="flex items-center gap-2.5">
              <span className="inline-flex items-center gap-1.5 rounded-full border border-destructive/40 bg-destructive/10 text-destructive px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wider">
                <ShieldAlert className="h-3 w-3" />
            ...
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              Under Article 6 of the EU AI Act, systems linked to safety components of products subject to third-party conformity assessments under Annex I are strictly designated as High-Risk and require robust compliance.
            </p>
          </div>
